...
##curl --progress-bar --remote-name --location "https://github.com/trashbus99/profork/raw/main/$appname/extra/$c1"
##curl --progress-bar --remote-name --location "https://github.com/trashbus99/profork/raw/main/$appname/extra/$c2"
# --- join
##cat $temp/cockatrice.tar.bz2.parta* >$temp/cockatrice.tar.gz
###curl --progress-bar --remote-name --location "https://github.com/trashbus99/profork/raw/main/$appname/extra/cockatrice.zip"
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/.batocera https://github.com/trashbus99/profork/raw/main/$appname/extra/batocera.sh
...
wget --tries=10 -q -O "/userdata/roms/ports/$appname.sh.keys" "https://github.com/trashbus99/profork/raw/main/main/$appname/extra/$appname.sh.keys"
# --------------------------------------------------------------------
