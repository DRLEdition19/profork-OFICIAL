...
# --------------------------------------------------------------------
# --------------------------------------------------------------------
APPNAME=HYDORAH # for installer info
appname=hydorah # directory name in /userdata/system/pro/...
...
######################################################################
######################################################################
echo 'DISPLAY=:0.0 /userdata/system/pro/'$appname'/'$appname'.flatimage --select-index=0 "$@"' >> $launcher
######################################################################
######################################################################
######################################################################
######################################################################
