#!/usr/bin/env bash
clear
echo "Final Yuzu/Ryujinx build puller for batocera"
sleep 3
echo "This pulls final yuzu/ryujinx 1403 builds from archive.org. 1403 didn't work when tested.  archive.org is slow. be patient"
...
#                
#   ANIMATION=YES
#   plays loading animation when starting the updater    
#
################################################################################
#
UPDATES=UNLOCKED
