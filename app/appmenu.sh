...
apps=(
    ...
    ["PS2MINUS/PCX2-v1.6-OLDER-COMPUTERS"]="curl -Ls https://github.com/uureel/batocera.pro/raw/main/ps2minus/installer.sh | bash"
    ["PS2PLUS/NEWEST-PCSX2"]="curl -Ls https://github.com/uureel/batocera.pro/raw/main/ps2plus/installer.sh | bash"
    ["PS3PLUS/NEWEST-RPCS3"]="curl -Ls https://github.com/uureel/batocera.pro/raw/main/ps3plus/installer.sh | bash"
