...
apps=(
    ...
    ["PLEX/DOCKER"]="curl -L https://github.com/trashbus99/profork/raw/master/docker/plex.sh | bash"
    ...
    ["SHADPS4"]="curl -LShttps://github.com/trashbus99/profork/raw/master/shadps4/shadps4.sh | bash"
