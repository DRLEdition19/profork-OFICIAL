...
curl -L https://github.com/trashbus99/profork/raw/main/app/pro.sh -o /userdata/system/pro/pro.sh

# Download BatoceraPRO.sh to /userdata/roms/ports
curl -L https://github.com/trashbus99/profork/raw/main/app/BatoceraPRO.sh -o /userdata/roms/ports/BatoceraPRO.sh
