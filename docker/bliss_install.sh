...
dialog --title "Warning" --yesno "This container is experimental and not supported profork. Contact sickcodes github repo or bliss os for support. Proceed?" 15 80
...
mkdir -p ~/pro/bliss
curl -Ls https://github.com/trashbus99/profork/raw/main/docker/bliss.sh -o ~/pro/bliss/bliss.sh
chmod +x ~/pro/bliss/bliss.sh
sleep 5

echo "Installing Shortcut to ports..."
mkdir -p /userdata/roms/ports
curl -Ls https://github.com/trashbus99/profork/raw/main/docker/Bliss-OS.sh -o /userdata/roms/ports/Bliss-OS.sh
...
sleep 5
curl -Ls https://github.com/trashbus99/profork/raw/main/docker/bliss_cli.sh | bash
