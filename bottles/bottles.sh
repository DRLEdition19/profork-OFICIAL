...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.pnghttps://github.com/trashbus99/profork/raw/master/bottles/extra/bottles.png; chmod a+x $dep/* 2>/dev/null; cd ~/
