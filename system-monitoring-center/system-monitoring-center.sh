...
wget -q -O "/userdata/roms/ports/system-monitoring-center.sh.keys" "https://github.com/trashbus99/profork/raw/main/main/system-monitoring-center/extra/system-monitoring-center.sh.keys"
# --------------------------------------------------------------------
