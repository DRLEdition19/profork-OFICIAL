...
URL="https://github.com/trashbus99/profork/releases/download/r1/Space.Quest.2.VGA.wsquashfs"
KEYS_URL=  # Leave empty if no keys file is needed
DEST_DIR="/userdata/roms/windows"
MESSAGE="SQ2VGA- Needs Enable Mouse and Esync in adv. settings before running"  # Leave empty if no message is needed
