#!/usr/bin/env bash 
######################################################################
# PROFORK/MINECRAFT-BEDROCK EDITION INSTALLER
######################################################################
...
APPLINK=https://github.com/minecraft-linux/appimage-builder/releases/download/v1.0.0-798/Minecraft_Bedrock_Launcher-bookworm-x86_64-v1.0.0.798.AppImage
...
wget https://github.com/trashbus99/profork/raw/master/bedrock/shortcut/Minecraft-Bedrock.sh -O /userdata/roms/ports/Minecraft-Bedrock.sh > /dev/null 2>&1 && chmod +x /userdata/roms/ports/Minecraft-Bedrock.sh > /dev/null 2>&1
echo "DONE"
sleep 3
