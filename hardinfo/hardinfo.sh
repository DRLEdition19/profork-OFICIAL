...
APPLINK=https://github.com/trashbus99/profork/releases/download/r1/hardinfo.AppImage
...
wget --tries=10 -q -O "/userdata/roms/ports/$appname.sh.keys" "https://github.com/trashbus99/profork/raw/master/master/$appname/extra/$appname.sh.keys"
# --------------------------------------------------------------------
# //
