...
url=https://github.com/trashbus99/profork/raw//
cd $temp
...
wget -q -O "/userdata/roms/ports/ludusavi.sh.keys" "https://github.com/trashbus99/profork/raw/master/ludusavi/extra/ludusavi.sh.keys"
# --------------------------------------------------------------------
