...
# --------------------------------------------------------------------
# --------------------------------------------------------------------
APPNAME="ARCADE-MANAGER" # for installer info
appname=arcade-manager # directory name in /userdata/system/pro/...
AppName=arcade-manager # App.AppImage name
APPPATH=/userdata/system/pro/$appname/$AppName.AppImage
APPLINK=$(curl -s https://api.github.com/repos/cosmo0/arcade-manager/releases/latest | jq -r '.assets[] | select(.name | endswith("linux-x64.AppImage")) | .browser_download_url')
ORIGIN=GITHUB.COM/COSMO0/ARCADE-MANAGER
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/trashbus99/profork/raw/master/arcade-manager/extra/arcade-manager.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
######################################################################
######################################################################
echo 'LD_LIBRARY_PATH=/userdata/system/pro/.dep:${LD_LIBRARY_PATH} QT_FONT_DPI=128 QT_SCALE_FACTOR=1 GDK_SCALE=1 DISPLAY=:0.0 /userdata/system/pro/arcade-manager/arcade-manager.AppImage --no-sandbox ${@}' >> $launcher
######################################################################
######################################################################
######################################################################
######################################################################
...
wget -q -O $icon https://github.com/trashbus99/profork/raw/master/arcade-manager/extra/arcade-manager.png
# //
