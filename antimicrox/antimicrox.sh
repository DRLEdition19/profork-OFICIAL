...
mkdir -p ~/pro/.dep 2>/dev/null && cd ~/pro/.dep && wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O ~/pro/.dep/dep.zip https://github.com/trashbus99/profork/raw/maser/.dep/dep.zip && yes "y" | unzip -oq ~/pro/.dep/dep.zip && cd ~/
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/trashbus99/profork/raw/maser/$appname/extra/icon.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
wget -q -O $icon https://github.com/trashbus99/profork/raw/maser/$appname/extra/icon.png
# //
