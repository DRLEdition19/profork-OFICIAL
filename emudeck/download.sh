...
BASE_URL="https://github.com/trashbus99/profork/tree/master/emudeck/shortcuts"
...
base_url_fix_parser="https://github.com/trashbus99/profork/tree/master/emudeck/fix_parser"
