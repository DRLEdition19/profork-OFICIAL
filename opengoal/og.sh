...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/trashbus99/profork/raw/master/opengoal/extra/opengoal.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
dos2unix $launcher
chmod a+x $launcher
cp $launcher /userdata/roms/ports/Open-Goal.sh 2>/dev/null
...
wget -q -O $icon https://github.com/trashbus99/profork/raw/master/opengoal/extra/opengoal.png
# //
