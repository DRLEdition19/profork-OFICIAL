...
APPLINK=https://github.com/endless-sky/endless-sky/releases/download/v0.10.10/Endless_Sky-v0.10.10-x86_64.AppImage
ORIGIN="//github.com/endless-sky/endless-sky" # credit & info
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
...
echo
echo -e "${W}$APPNAME WILL BE AVAILABLE IN F1->APPLICATIONS and PORTS "
...
wget -q -O $icon https://github.com/trashbus99/profork/raw/master/endlesssky/extra/icon.png
# //
