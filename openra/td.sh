#!/usr/bin/env bash 
######################################################################
# PROFORK/OPENRA/TD INSTALLER
######################################################################
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
APPNAME=OPENRA-TIBERIAN-DAWN # for installer info
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/trashbus99/profork/raw/master/openra/extra/cnctd.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
wget -q -O $icon https://github.com/trashbus99/profork/raw/master/openra/extra/cnctd.png
# //
