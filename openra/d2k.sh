...
# --------------------------------------------------------------------
# --------------------------------------------------------------------
APPNAME=OPENRA-DUNE-2000 # for installer info
appname=openradune2k # directory name in /userdata/system/pro/...
AppName=$appname # App.AppImage name
APPPATH=/userdata/system/pro/$appname/$appname.AppImage
#APPLINK=http://PROFORK/app/$appname.AppImage
APPLINK=https://github.com/OpenRA/OpenRA/releases/download/release-20231010/OpenRA-Dune-2000-x86_64.AppImage
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/trashbus99/profork/raw/master/openra/extra/d2k.jpg; chmod a+x $dep/* 2>/dev/null; cd ~/
...
dos2unix $launcher
chmod a+x $launcher
cp $launcher /userdata/roms/ports/OpenRA-Dune-2000.sh 2>/dev/null
...
wget -q -O $icon https://github.com/trashbus99/profork/raw/master/openra/extra/d2k.jpg
# //
