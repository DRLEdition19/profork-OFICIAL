...
APPLINK=https://github.com/OpenRA/OpenRA/releases/download/release-20231010/OpenRA-Red-Alert-x86_64.AppImage
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/trashbus99/profork/raw/master/openra/extra/cncra.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
dos2unix $launcher
chmod a+x $launcher
cp $launcher /userdata/roms/ports/OpenRA-Red-Alert.sh 2>/dev/null
