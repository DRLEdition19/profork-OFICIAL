...
wget --tries=10 -q -O "/userdata/roms/ports/$appname.sh.keys" "https://github.com/trashbus99/profork/raw/master/$appname/extra/$appname.sh.keys"
# --------------------------------------------------------------------
# //
