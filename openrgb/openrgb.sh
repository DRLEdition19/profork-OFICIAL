...
# --------------------------------------------------------------------
# --------------------------------------------------------------------
APPNAME=OPENRGB # for installer info
appname=openrgb # directory name in /userdata/system/pro/...
AppName=$appname # App.AppImage name
APPPATH=/userdata/system/pro/$appname/$appname.AppImage
#APPLINK=http://PROFORK/app/$appname.AppImage
APPLINK=https://openrgb.org/releases/release_0.9/OpenRGB_0.9_x86_64_b5f46e3.AppImage
ORIGIN="https://openrgb.org/releases.html" # credit & info
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
# --------------------------------------------------------------------
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/trashbus99/profork/raw/master/openrgb/extra/icon.jpg; chmod a+x $dep/* 2>/dev/null; cd ~/
...
echo 'LD_LIBRARY_PATH="/userdata/system/pro/.dep:${LD_LIBRARY_PATH}" DISPLAY=:0.0 /userdata/system/pro/'$appname'/'$appname'.AppImage --gui "$@"' >> $launcher
######################################################################
######################################################################
######################################################################
######################################################################
