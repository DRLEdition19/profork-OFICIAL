...
export aur_packagelist="geforcenow-electron obs-studio-tytan652 sudachi-bin mcpelauncher-appimage parsec-bin protonup-qt freefilesync-bin sgdboop-bin winegui-bin"
