...
#------------------------------------------------
  "$conty" \
          ...
          --bind / /batocera \
  xterm -fs 12 -maximized -fg '#888888' -bg black -fa "DejaVuSansMono" -en UTF-8 -e bash -c 'ulimit -H -n 819200 && ulimit -S -n 819200 && sysctl -w fs.inotify.max_user_watches=8192000 vm.max_map_count=2147483642 fs.file-max=8192000 >/dev/null 2>&1 && DISPLAY=:0.0 dbus-run-session steam'
#------------------------------------------------
# batocera-mouse hide
#------------------------------------------------
