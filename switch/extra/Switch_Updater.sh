...
#link_yuzuea=https://github.com/trashbus99/profork/raw/main/switch/extra/Linux-Yuzu-EA-3180.AppImage
# ----------------------------------------------------------------------------------
# PATHS: 
...
cd $temp/$emu
wget -q -O "$extra/$emu/xdg-mime" "https://github.com/trashbus99/profork/raw/main/switch/extra/xdg-mime"
