...
wget -q -O "$path/batocera-switch-updater.sh" "https://github.com/trashbus99/profork/raw/main/main/tmp/switch/update.sh"
...
wget -q -O "/tmp/batocera-switch-updater.sh" "https://github.com/trashbus99/profork/raw/main/switch/tmp/update.sh" 
